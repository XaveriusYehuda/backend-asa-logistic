...
function generateRfqInternationalFFPdf(data, outputPath) {
    ...
    return new Promise((resolve, reject) => {
        ...
        field(doc,"Shipping Instruction","Terlampir");

        field(doc,"Pemberitahuan Ekspor Barang","Terlampir");

        field(doc,"Foto Barang","Terlampir");
...
module.exports = generateRfqInternationalFFPdf;