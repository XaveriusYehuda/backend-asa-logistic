...
function generateRfqImportClearancePdf(data, outputPath) {
    ...
    return new Promise((resolve, reject) => {
        ...
        field(doc,"Bill of Lading","Terlampir");

        field(doc,"Certificate of Origin","Terlampir");
...
module.exports = generateRfqImportClearancePdf;