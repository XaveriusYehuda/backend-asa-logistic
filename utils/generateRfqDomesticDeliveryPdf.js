...
function generateRfqDomesticDeliveryPdf(data, outputPath) {
    ...
    return new Promise((resolve, reject) => {
        ...
        field(doc,"Alamat Pengambilan",data.shipping_address);

        field(doc,"Alamat Pengiriman",data.destination_address);

        field(doc,"Total Berat Kotor",data.goods_gross_weight);

        field(doc,"Total Volume",data.goods_volume);

        field(doc,"Jenis Armada",data.fleet_type);
...
module.exports = generateRfqDomesticDeliveryPdf;